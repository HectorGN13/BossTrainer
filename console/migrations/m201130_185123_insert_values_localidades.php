...
/**
 * Class m201130_185123_insert_values_localidades
 */
class m201130_185123_insert_values_localidades extends Migration
{
    private $_localidades = "{{%localidades}}";
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        Yii::$app->db->createCommand()->batchInsert($this->_localidades, ['provincia_id', 'nombre_localidad'], [
            [1,'Alegría-Dulantzi'],
            [2,'Abengibre'],
            [3,'Adsubia'],
            [4,'Abla'],
    ...
    {
        foreach ((new Query)->from('localidades')->each() as $localidad) $this->delete( $this->_localidades,['id' => $localidad['id'] ]);
    }
    ...
    {
        echo "m201130_185123_insert_values_localidades cannot be reverted.\n";
