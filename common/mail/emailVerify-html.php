            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td bgcolor="#ffffff" align="center" valign="top" style="padding: 40px 20px 20px 20px; border-radius: 4px 4px 0px 0px; color: #111111; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 48px; font-weight: 400; letter-spacing: 4px; line-height: 48px;">
                        ...
                        <h3 style="font-weight: 700; margin: 5%; text-transform:capitalize;">¡Bienvenido <?= Html::encode($user->username) ?>!</h3>
                    </td>
                </tr>
            </table>
        </td>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="center" style="border-radius: 3px;" bgcolor="#000">
                                                <?= Html::a('Verificar Correo', $verifyLink , ['style' => ['font-size' => '20px', 'font-family' => 'Helvetica, Arial, sans-serif', 'color' => '#fff', 'text-decoration' => 'none', 'padding' => '15px 25px', 'border-radius' => '2px', 'border' => '1px solid #000', 'display' => 'inline-block']])?>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
